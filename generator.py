...
class Generator(object):
    def __init__(self, num_emb, batch_size, emb_dim, hidden_dim, sequence_length, start_token,
        ...
        # placeholder definition, sequence of tokens generated by generator
        ...
        # processed for batch
        with tf.device("/cpu:0"):  # seq_length x batch_size x emb_dim
        ...
        def _g_recurrence(i, x_t, h_tm1, gen_o, gen_x):
            ...
            gen_o = gen_o.write(i, tf.reduce_sum(tf.multiply(
                tf.one_hot(next_token, self.num_emb, 1.0, 0.0), tf.nn.softmax(o_t)), 1))  # [batch_size] , prob
